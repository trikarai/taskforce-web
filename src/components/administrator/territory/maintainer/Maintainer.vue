<template>
  <v-container grid-list-xs>
    ...
    <v-scale-transition>
      <organization-list v-if="showUser" :ass="ass" @refresh="refresh" />
    </v-scale-transition>
...
import OrganizationList from "@/components/administrator/territory/maintainer/OrganizationList";
...
export default {
  ...
  methods: {
    ...
    leftAct(item, action) {
      ...
      this.leftId = item.id;
      this.leftName = item.organization_name;
